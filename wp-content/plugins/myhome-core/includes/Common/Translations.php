...
class Translations {
	...
	public static function get_frontend() {
		return array(
			...
			'no_user'           => wp_kses( __( 'There is no user registered with that email address.', 'myhome-core' ), array() ),
	...
	public static function get_backend() {
		return array(
			'required_breadcrumbs'              => wp_kses( __( 'This field is a part of the breadcrumbs and is required by the URL structure. If you do not wish to make it required, please remove it from the breadcrumbs in the MyHome Theme / Breadcrumbs', 'myhome-core' ), array() ),
