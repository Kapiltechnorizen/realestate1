...
class Estate_Data {
	...
	public static function get_data( $estate ) {
		...
		$data = array(
			...
			'image_srcset'      => \MyHomeCore\My_Home_Core()->images->get( $estate->get_image_id(), 'myhome-standard-xs' ),
			...
			'gallery'           => $estate->get_gallery_data( $gallery_limit ),
