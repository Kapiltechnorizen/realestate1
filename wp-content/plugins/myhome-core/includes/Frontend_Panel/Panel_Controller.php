...
class Panel_Controller {
	...
	public function register() {
		...
		if ( ! empty( $set_type ) && isset( $user_data['account_type'] ) && ! empty( $user_data['account_type'] ) ) {
			$initial_role  = $user_data['account_type'];
	...
	public function reset_password() {
		...
		$message .= '<a href="' . admin_url( "admin-post.php?action=myhome_user_panel_reset_password_link&key=$key&id=" . rawurlencode( $user_data->ID ) ) . '">' . esc_html__( 'Reset password', 'myhome-core' ) . '</a>\r\n"';
