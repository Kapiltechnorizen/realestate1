	...
	public function get_vc_params() {
		...
		$params = array(
			array(
				...
				'description' => esc_html__( 'List of widgets refresh every 60 minutes. If you wish to refresh the list visit /wp-admin/ >> MyHome Theme and click "Clear Cache" button (next to the "save changes" button) and refresh this page', 'myhome-core' ),
				'param_name'  => 'widget',
				'value'       => $widgets_list,
				'save_always' => true
			),
