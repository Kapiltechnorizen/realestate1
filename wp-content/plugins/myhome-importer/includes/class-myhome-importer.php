		...
		public function page() {
			...
			<div class="mh-server">
				...
				<div class="mh-server__intro">
					...
					<a href="mailto:support@tangibledesign.net">support@tangibledesign.net</a>. We will do our best to help you. If the problem is related to the below server settings please contact your hosting provider first.
				</div>
					...
					<?php if ( phpversion() < $min_php_version ) : ?>
						<div class="mh-server__problem">
							<div class="mh-server__problem__text">
								PHP version installed on your server is outdated. PHP version 5.6 or higher is required to make sure MyHome and all required plugins work correctly.
							</div>
							<div class="mh-server__problem__solve">
								<a href="https://myhometheme.zendesk.com/hc/en-us/articles/360001522353" target="_blank">
									<span class="dashicons dashicons-arrow-right-alt2"></span>Click here to read how to solve it
								</a>
							</div>
						</div>
					<?php endif ?>
                ...
                ">
					...
					<?php if ( $max_input_vars < $min_input_vars ) : ?>
						<div class="mh-server__problem">
							<div class="mh-server__problem__text">
								Please increase it to 1000 or more. Lower number can create some unexpected problems, because it is responsible for how many GET/POST/COOKIE input variables may be accepted.
							</div>
						</div>
					<?php endif ?>
				</div>
                ...
                ">
					...
					<?php if ( $memory_limit < $min_memory_end && $memory_limit != 0 ) : ?>
						<div class="mh-server__problem">
							<div class="mh-server__problem__text">
								Your server has very low memory_limit. Please increase it to 196M or more to make sure MyHome and all required plugins work correctly
							</div>
							<div class="mh-server__problem__solve">
								<a href="https://myhometheme.zendesk.com/hc/en-us/articles/360001522393" target="_blank">
									<span class="dashicons dashicons-arrow-right-alt2"></span>Click here to read how to solve it
								</a>
							</div>
						</div>
...
">
					...
					<?php if ( $maX_execution_time < $min_execution_time && $maX_execution_time != 0 ) : ?>
						<div class="mh-server__problem">
							<div class="mh-server__problem__text">
								Your server has very low max_execution_time. We recommend to increase it to 60 (seconds) or more to make sure importer will have enough time to load all sample photos and videos
							</div>
						</div>
					<?php endif ?>
				</div>
                ...
                ">
					...
					<?php if ( $php_gd != $php_gd_requirement ) : ?>
						<div class="mh-server__problem">
							<div class="mh-server__problem__text">
								PHP GD is not installed on your server. It is required to generate image thumbnails by any WordPress Theme. Please contact your server provider how to turn it "on"
							</div>
						</div>
					<?php endif ?>
				</div>
                ...
                ">
					...
					<?php if ( $mb_string != $mb_string_requirement ) : ?>
						<div class="mh-server__problem">
							<div class="mh-server__problem__text">
								PHP mbstring is not installed on your server. It is required to run almost any modern WordPress theme or plugin. Please contact your server provider how to turn it "on"
							</div>
						</div>
					<?php endif ?>
				</div>
			...
			<div id="myhome-importer">
				<div class="mh-info-database">
					...
					IMPORTANT - Loading Demo will remove all of your database content. Before you start importing demo make sure you activated all required plugins.
				</div>
