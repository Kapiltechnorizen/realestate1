				...
				<div class="mh-grid">
					<?php foreach ( $myhome_agency_agents as $myhome_agency_agent ) : ?>
						<div class="mh-grid__1of4 mh-agency-agents__single">
							<a class="mh-agency-agents__single__img-link" href="<?php echo $myhome_agency_agent->get_link(); ?>">
								<div class="mh-agency-agents__single__img-wrapper">
									<?php $myhome_agency_agent->image(); ?>
								</div>
								<h4 class="mh-agency-agents__heading"><?php echo $myhome_agency_agent->get_name(); ?></h4>
							</a>
						</div>
					<?php endforeach; ?>
				</div>
