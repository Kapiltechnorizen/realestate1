	...
	class My_Home_Redux {
		...
		public function set_listing_options() {
			...
			if ( class_exists( '\MyHomeCore\Components\Listing\Search_Forms\Search_Form' ) ) {
				...
				$sort_by = array(
					\MyHomeCore\Estates\Estate_Factory::ORDER_BY_NEWEST            => esc_html__( 'Newest', 'myhome-core' ),
					\MyHomeCore\Estates\Estate_Factory::ORDER_BY_PRICE_HIGH_TO_LOW => esc_html__( 'Price (high to low)', 'myhome-core' ),
					\MyHomeCore\Estates\Estate_Factory::ORDER_BY_PRICE_LOW_TO_HIGH => esc_html__( 'Price (low to high)', 'myhome-core' ),
					\MyHomeCore\Estates\Estate_Factory::ORDER_BY_POPULAR           => esc_html__( 'Popular', 'myhome-core' ),
					\MyHomeCore\Estates\Estate_Factory::ORDER_BY_TITLE_ASC         => esc_html__( 'Alphabetical order', 'myhome-core' ),
					\MyHomeCore\Estates\Estate_Factory::ORDER_BY_TITLE_DESC        => esc_html__( 'Reverse alphabetical order', 'myhome-core' ),
				);
			}
		...
		public function migrate_design() {
			$sections = array(
				...
				'mh-color__user-panel-menu-header-bg',
				'mh-color__user-panel-menu-header-font',
				'mh-color__user-panel-menu-element-font',
				'mh-color__user-panel-menu-element-bg',
				'mh-color__user-panel-menu-element-font-hover',
				'mh-color__user-panel-menu-element-bg-hover',
				'mh-color__user-panel-menu-element-active-font',
				'mh-color__user-panel-menu-element-active-background',
				'mh-color__user-panel-h1',
				'mh-color__user-panel-h1-separator',
				'mh-color__user-panel-property-form-label',
